...
//  Masque
//
//  Created by Jason Zheng on 3/16/17.
...
class MenuBar: UIView, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    lazy var collectionView: UICollectionView = {
        ...
        cv.backgroundColor = UIColor(red: 51/255, green: 90/255, blue: 149/255, alpha: 1)
        cv.dataSource = self
        cv.delegate = self
        return cv
    }()
...
//        }, completion: nil)
        ...
        feedController?.scrollToMenuIndex(menuIndex: indexPath.item)
    }
