...
//        customFBButton.setTitleColor(.white, for: .normal)
        ...
        var registerLabel = UILabel(frame: CGRect(x: 100, y: 70, width: view.frame.width-32, height: 100))
    ...
    let pages: [Page] = {
        let firstPage = Page(title: "Welcome To BlanQ", message: "An app built to support the LGBT community", imageName: "page1")
        ...
        let thirdPage = Page(title: "QuASA Chat", message: "Chat with someone from the USC QuASA center anonymously.", imageName: "page3")
